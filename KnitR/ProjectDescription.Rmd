...
- **checkExists(alias,header)** *Checks if a table exists. Currently doesn't function due to a possible quoting issue.*
...
- **getLastUpdated(series_id,header)** *Being implmented. Will return the UPDATED field from the LAST_UPDATE table for the specified series_id (or alias.)*
